...
dataset = genfromtxt('C:/Users/HP/Desktop/sudhnya/internship/heart_disease_dataset.csv',delimiter=',')
...
X_train1,X_test1,Y_train1,Y_test1 = cross_validate.train_test_split(X_new, Y, test_size = 0.2, train_size=0.1, random_state=0)
